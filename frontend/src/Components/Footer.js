        ...
        <div className="flex justify-center border-t-2 border-gray-200">
            <div>
                ...
                <li className="mr-6">
                    ...
                    <li className="mr-6">
                        <h2 className="text-black transition ease-in-out  hover:-translate-y-1 hover:scale-110  duration-300">Jason Stuart</h2>
                    </li>
                    <li className="mr-6">
                        <h2 className="text-black transition ease-in-out  hover:-translate-y-1 hover:scale-110  duration-300">Nikita Zaytsev</h2>
                    </li>
                    <li className="mr-6">
